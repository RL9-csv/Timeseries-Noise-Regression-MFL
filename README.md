...
PCA 적용 결과 결론
- 해당 프로젝트의 가장 큰 문제인 5번째 폴드 성능 저하 문제를 해결하기 위해, 600여 개의 피처에 내재된 노이즈와 다중공선성을 제거하기 위해서 PCA 차원 축소 실험을 진행하였습니다. 결론부터 말하자면 PCA 모델은 기존에 비교 대상으로 600여 개의 피처를 전부 포함한 모델링 결과 보다 더 낮은 성능을 기록하였습니다. 즉, 성능 개선에는 실패를 하였습니다.
1. 결측값 처리의 함정
